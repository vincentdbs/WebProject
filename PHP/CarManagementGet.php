<?php
    ...
    while($rows = mysqli_fetch_array($result)){ //display result in table
        ...
        echo "<img src='../Icon/bin.png' class=\"icon_car modify-icon\" onclick='deleteCar(" . $rows['car_id'] .")'>";
        echo "<img src='../Icon/edit.png' class=\"icon_car modify-icon\" onclick='editCar(" . $rows['car_id'] .")'>";
        echo "<table>";
        echo "<tr>";
